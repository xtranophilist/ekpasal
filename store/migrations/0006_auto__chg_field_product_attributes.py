...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.attributes'
        db.alter_column(u'store_product', 'attributes', self.gf('jsonfield.fields.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'Product.attributes'
        db.alter_column(u'store_product', 'attributes', self.gf('jsonfield.fields.JSONField')(default=None))
