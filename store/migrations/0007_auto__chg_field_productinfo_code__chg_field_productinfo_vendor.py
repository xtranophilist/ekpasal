...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductInfo.code'
        db.alter_column(u'store_productinfo', 'code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ProductInfo.vendor'
        db.alter_column(u'store_productinfo', 'vendor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.Vendor'], null=True))

    def backwards(self, orm):

        # Changing field 'ProductInfo.code'
        db.alter_column(u'store_productinfo', 'code', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'ProductInfo.vendor'
        db.alter_column(u'store_productinfo', 'vendor_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['store.Vendor']))
